# Frengo - Crossplane playground Configurations

This repository contains all the configuration resources required for the Frengo - Crossplane playground project to function properly and expose its business features.
